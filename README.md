- [安装 ArcoLinux-i3wm 之后的配置](#---arcolinux-i3wm------)
  * [预览](#--)
  * [搭建基础环境](#------)
    + [安装 fish](#---fish)
    + [使用 Xfce4-terminal](#---xfce4-terminal)
    + [设置 Rofi](#---rofi)
    + [设置亮度](#----)
      - [通过 xfce4-power-manager-settings](#---xfce4-power-manager-settings)
      - [通过 brightnessctl](#---brightnessctl)
    + [更新系统](#----)
    + [安装拼音输入法](#-------)
    + [安装 VSCode](#---vscode)
    + [安装浏览器](#-----)
  ...
  * [编程软件](#----)
    ...
    + [Java, Jetbrains](#java--jetbrains)
      ...
      - [解决输入法位置 bug](#--------bug)
      - [解决 Intellij terminal 对 fish shell 的不适配](#---intellij-terminal---fish-shell-----)
      - [jshell](#jshell)
    + [Python](#python)
